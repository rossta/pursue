...
# describe GravatarImageTag, :pending do
...
#       it "#gravatar_image_tag should create the provided url with the provided options #{options}", :pending do
...
#     }.each do |params, options|
#       it "#gravatar_image_tag #{params} should create the provided url when defaults have been set with the provided options #{options}", :pending do
#         image_tag = view.gravatar_image_tag(email, options)
...
#       expect(view.gravatar_image_tag(email, { gravatar: { secure: false } })).to match(/^https:\/\/secure.gravatar.com\/avatar\//)
#     end
...
#       expect(view.gravatar_image_tag(email)).match(/height="80"/)
#       expect(view.gravatar_image_tag(email)).match(/width="80"/)
#     end
...
#       expect(view.gravatar_image_tag(email, gravatar: { size: 45 })).match(/height="45"/)
#       expect(view.gravatar_image_tag(email, gravatar: { size: 75 })).match(/width="75"/)
#     end
...
#       expect(view.gravatar_image_url(email).to include("default=#{default_image_escaped}")).should be_true
#     end
